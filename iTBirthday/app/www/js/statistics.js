  ...
  .controller('StatisticsCtrl', function ($scope, $http, ionicLoadingService) {
    ...
    $scope.getStatistics = function () {
      ...
      $http.get(serverUrl + '/statistics').success(function (response) {
        ...
        $scope.lineData = [[$scope.statistics.AgeGroups['18to21'],$scope.statistics.AgeGroups['21to25'],
          $scope.statistics.AgeGroups['25to30'],$scope.statistics.AgeGroups['30to40'],
          $scope.statistics.AgeGroups['40+']]];
